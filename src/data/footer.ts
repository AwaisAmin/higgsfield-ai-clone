 ...
 * Footer data.
 *
 * Legal hrefs and social URLs were read off higgsfield.ai on 2026-09-16. The
 * four link columns are this rebuild's own grouping -- the live footer only
 * carries the bottom legal row -- mapped onto the real product routes.
 *
 * Brand glyph paths are from simple-icons (CC0), 24x24 viewBox.
 */
...
export type SocialLink = FooterLink & { path: string };

export const footerColumns: readonly FooterColumn[] = [
  {
    title: "Create",
    links: [
      { label: "Image", href: "/ai/image?model=gpt_image_2" },
...
export const socialLinks: readonly SocialLink[] = [
  ...
  {
    label: "Discord",
    href: "https://discord.com/invite/higgsfield",
    external: true,
